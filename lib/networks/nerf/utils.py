...
def get_embedder(multires, i=0):
    ...
    # 第一个返回值是lamda，给定x，返回其位置编码,第二个值是记录最后的维度大小方便后续使用
...
def get_rays(H, W, K, c2w):
    ...
    # rays_d [400,400,3] 得到的是世界坐标系下的射线方向向量，由归一化相机坐标系下的射线方向向量通过c2w转换而来
...
def ndc_rays(H, W, focal, near, rays_o, rays_d):
    """
    rays_d [400,400,3]
    rays_o [400,400,3] 相机在世界系下的坐标
    """
    # Shift ray origins to near plane
    t = -(near + rays_o[..., 2]) / rays_d[..., 2]
    # 代表shift后射线原点的世界坐标系坐标
